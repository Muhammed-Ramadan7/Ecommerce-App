...
import { FaFacebook, FaShoppingCart, FaTiktok, FaTwitter, FaYoutube } from "react-icons/fa";
        ...
        >
          ...
          <ul className="font-medium flex items-center flex-col p-4 xl:p-0 mt-4 border border-gray-100 rounded-xl bg-gray-50 xl:flex-row xl:space-x-8 rtl:space-x-reverse xl:mt-0 xl:border-0 xl:bg-white dark:bg-gray-800 xl:dark:bg-gray-900 dark:border-gray-700">
            ...
            {token && (
              ...
              <li >
                <span className="block relative cursor-pointer py-2 px-3 text-gray-900 rounded hover:bg-gray-100 xl:hover:bg-transparent xl:border-0 xl:hover:text-green-700 xl:p-0 dark:text-white xl:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white xl:dark:hover:bg-transparent">
                  <FaShoppingCart className="text-xl"/>
                  <span className="absolute text-red-800 top-0 right-0 translate-y-1/2 translate-x-1/2">{cartItem}</span>
                </span>
              </li>
